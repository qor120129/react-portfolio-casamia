...
const LineBanner = ({ lineBannerImg, title, subTitle, className }) => {
  return (
    <section className={`max-w-[80rem] my-12 m-auto ${className} overflow-hidden relative before:absolute before:inset-0 before:bg-black before:opacity-50 before:block before:z-10 `}>
